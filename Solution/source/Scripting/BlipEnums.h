...
*
* Blip-related enum definitions extracted from GTAblip.h.
* This header carries the bulk of icon/type/colour tables so GTAblip.h
* itself can stay focused on the GTAblip class and its API.
*/
#pragma once
