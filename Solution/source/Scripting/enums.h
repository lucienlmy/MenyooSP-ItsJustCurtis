...
namespace ePedConfigFlags
{
	enum ePedConfigFlags
	{
		...
		_0xF3F5758C = 290,
		_0x2A9307F1 = 291,
		_FreezePosition = 292, // 0x7403D216
		_0xA06A3C6C = 293,
		...
		DisableTakeOffScubaGear = 409, //prevents the player to automatically removing the scuba gear
